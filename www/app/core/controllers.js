...
.controller('TabController', function () {
           ...
           datasets: [
               {
                   ...
                   fillColor: "#f9f9f9",
                   strokeColor: "rgb(0, 109, 240)",
                   pointColor: "rgba(0, 109, 240,0.9)",
                   pointStrokeColor: "#fff",
                   pointHighlightFill: "rgba(138, 43, 226,0.6)",
               ...
               },
                  {
                   ...
                   pointHighlightStroke: "rgba(220,220,220,1)",
                   data: [55, 19, 48, 91, 56, 55, 40]
               },

                                  {
                   label: "My First dataset",
                   fillColor: "#f9f9f9",
                   strokeColor: "rgb(255, 218, 68)",
                   pointColor: "rgb(255, 218, 68)",
                   pointStrokeColor: "#fff",
                   pointHighlightFill: "#fff",
                   pointHighlightStroke: "rgba(220,220,220,1)",
                   data: [65, 19, 48, 81, 56, 55, 40]
               },
                                  {
                   label: "My First dataset",
                   fillColor: "#f9f9f9",
                   strokeColor: "rgb(145, 220, 90)",
                   pointColor: "rgb(145, 220, 90)",
                   pointStrokeColor: "#fff",
                   pointHighlightFill: "#fff",
                   pointHighlightStroke: "rgba(220,220,220,1)",
                   data: [63, 41, 44, 61, 16, 45, 24]
               },
                                  {
                   label: "My First dataset",
                   fillColor: "#f9f9f9",
                   strokeColor: "rgb(216, 0, 39)",
                   pointColor: "rgb(216, 0, 39)",
                   pointStrokeColor: "#fff",
                   pointHighlightFill: "#fff",
                   pointHighlightStroke: "rgba(220,220,220,1)",
                   data: [54, 41, 48, 68, 57, 35, 44]
               }
           ]
       };
  ...
  new Chart(ctx).Line(data, {
           onAnimationComplete: function () {
               ...
               var copyWidth = this.scale.xScalePaddingLeft - 10;
 ...
 // Questionaire  modal
                $ionicModal.fromTemplateUrl('app/intro/questionairre.html', {
                    scope: $scope,
                    animation: 'fade-in-scale',
                    backdropClickToClose: false
                }).then(function (modal) {
...
var newsTemplate =
    '<ion-popover-view class="medium right" style="top:480px !important;back">' +
    '<ion-content>' +
    '<div class="list">' +
      '<div class="item item-icon-left item-text-wrap" ng-click="newsPopover.hide($event);" ui-sref="tabs.conversations">' +
    ...
    '<i class="icon ion-ios-paper-outline"></i>Progress' +
    '</div>' +
    '<div class="item item-icon-left item-text-wrap" ng-click="newsPopover.hide($event);">' +
    '<i class="icon ion-ios-alarm-outline" ></i>Sessions' +
    '</div>' +
    '<div class="item item-icon-left item-text-wrap" ng-click="newsPopover.hide($event);" ui-sref="tabs.top">' +
    '<i class="icon ion-ios-pulse-strong"></i>Leaderboard' +
    '</div>' +
